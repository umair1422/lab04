...
Theme_linkoping<-function()
{
  ...
  myplot<- ggplot2::theme(plot.background = element_rect(fill = '#00b9e7', colour = NA),
   ...
   cowplot::draw_image("https://liu.se/polopoly/KoM/facebookbilder/linkuniv_sigill_facebook_314px.jpg", scale = 0.3, x = -0.3, y = -0.3)
